...
base_path = "D:/workspace/TTS/onnx/gsv_2"
full_prec_model = "t2s_decoder.onnx"
inter_model = "t2s_decoder_pre.onnx"
model_target = "t2s_decoder_pre_quantized.onnx"
...
class SubsetModelInputs(torch.utils.data.Dataset):
    def __init__(self, num=450):
        ...
        self.data = h5py.File("D:/workspace/TTS/quant_ds.hdf5")
    def __len__(self):
        return self.num
...
if __name__ == "__main__":
    ...
    provider_options = [{
                    'config_file': "./vaip_config.json",#"D:/workspace/TTS/ryzen-ai/vaip_config.json",
